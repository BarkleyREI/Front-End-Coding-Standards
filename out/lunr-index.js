...
index.add({
    ...
    body: "## How to push to gh-pages  `git add .`  `git commit -m \&quot;blah blah commit message\&quot;`  `git push origin master`  At this point you have pushed it to the github repository (hopefully your forked version)  Now to subtree into the pages branch  `git subtree push --prefix out origin gh-pages`  No futher steps, this pushes it to the branch and up to the repo "
});
